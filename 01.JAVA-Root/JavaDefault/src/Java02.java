public class Java02 {
    public static void main(String[] args) {
         ...
         /*************************************** 
          [ 데이터 유형 ]
            ...
            ***************************************/
            ...
            System.out.println("물고기가 맛있나"+isFishTasty);
            System.out.println("물고기가 맛있나"+(isFishTasty?" 엄청":" 별로"));

            // char 데이터 유형은 단일문자를 저장
            // 문자는 'A' 또는 'c' 같이 작은따옴표 사용필수
            ...
            // 아스키코드를 사용하여 출력가능
            // char형에 아스키코드에 해당한는 숫자를 넣으면 한글자 출력
            // 아스키코드 참조:
        ...
        */
        ...
        System.out.println("double를 int로: "+myInt2);
